                ...
                {user ? (
                      ...
                      >
                        {profile && (
                          <ul className='p-2 w-40 border-r bg-white absolute rounded right-0 shadow top-0 mt-16 z-10'>
                            <li className='cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none mt-2'>
                              <Link
                  ...
                  <div className='hidden xl:flex items-center'>
                    <Link to='/auth?action=login'>
                      <button className='bg-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-5 py-3 text-sm'>
                        Sign in
                      </button>
                    </Link>
                  </div>
